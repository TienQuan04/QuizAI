...
Hiển thị thời gian và tiến trình làm bài
Cho phép xem đáp án sau mỗi câu
Hiển thị kết quả sau khi hoàn thành bài
Phân tích kết quả và gợi ý học tập bằng AI
Giao diện đơn giản, dễ sử dụng
🧠 Công nghệ sử dụng
Ngôn ngữ: Java
Nền tảng: Android
API AI: Gemini (Google Generative Language API)
